    ...
    <div class="login obsah">
        ...
        <form action="index.php" method="post" enctype="multipart/form-data">
        	<div class="form-group">
				...
				<input id='input-email' class='txt txt-max-width' type='email' name='email' placeholder='E-mailová adresa' />
         	...
         	<div class="form-group">
				...
				<input id='input-password' class='txt txt-max-width' type='password' name='heslo' placeholder='Heslo' />
