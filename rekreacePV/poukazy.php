...
<tr class=zahlavi style="text-align : left;"><td>Poukaz <?php echo razeni("rok DESC,poukaz");?></td><td>od <?php echo razeni("nastup");?></td><td>do <?php echo razeni("konec");?></td><td style="width:180;">jméno <?php echo razeni("prijmeni");?></td><td>osob</td><td style="width:85">cena</td></tr>
<?php 	
...
<table cellpadding="0" cellspacing="0">
	...
	<tr><td>
		<table cellpadding="0" cellspacing="0">
			...
			<tr><td width="100">Zamìstnanec:</td><td><input type="text" id="nazev_zam" name="nazev_zam" size="42" maxlength="40" onchange="top.zmeneno = true;" value="<?php echo $_POST["nazev_zam"]?>"></td></tr>
			<tr><td>Cizí:</td><td><input type="text" id="nazev_ciz" name="nazev_ciz" size="42" maxlength="40" onchange="top.zmeneno = true;" value="<?php echo $_POST["nazev_ciz"]?>"></td></tr>
		</table>
	</td>
	<td>
		...
		<tr><td>dospìlí:</td><td><input type="text" id="osob_zam" name="osob_zam" size="3" maxlength="2" onchange="prepocti()" value="<?php echo $_POST["osob_zam"]?>"></td>
			<td>dìti:</td><td><input type="text" id="osob_zad" name="osob_zad" size="3" maxlength="2" onchange="prepocti()" value="<?php echo $_POST["osob_zad"]?>"></td>
		...
		<tr><td>dospìlí:</td><td><input type="text" id="osob_ciz" name="osob_ciz" size="3" maxlength="2" onchange="prepocti()" value="<?php echo $_POST["osob_ciz"]?>"></td>
			<td>dìti:</td><td><input type="text" id="osob_cid" name="osob_cid" size="3" maxlength="2" onchange="prepocti()" value="<?php echo $_POST["osob_cid"]?>"></td>
...
<tr><td width="100">Jméno:</td><td><input type="text" id="jmeno" name="jmeno" size="22" maxlength="20" onchange="top.zmeneno = true;" value="<?php echo $_POST["jmeno"]?>"></td>
	<td>pøíjmení:</td><td><input type="text" id="prijmeni" name="prijmeni" size="30" maxlength="30" onchange="top.zmeneno = true;" value="<?php echo $_POST["prijmeni"]?>"></td></tr>
<tr><td>Bydlištì:</td><td colspan="3"><input type="text" id="bydliste" name="bydliste" size="65" maxlength="60" onchange="top.zmeneno = true;" value="<?php echo $_POST["bydliste"]?>"></td></tr>
</table>
<table cellpadding="0" cellspacing="0" width="605">
<tr><td width="100">Nástup:</td><td><input type="text" class=cislo id="nastup" name="nastup" size="10" maxlength="10" onchange="prepocti()" value="<?php echo DateEnCz($_POST["nastup"])?>"></td>
	<td>ukonèení:</td><td><input type="text" class=cislo id="konec" name="konec" size="10" maxlength="10" onchange="prepocti()" value="<?php echo DateEnCz($_POST["konec"])?>"></td>
