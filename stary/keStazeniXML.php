...
if (!empty($_GET["slozka"])) {
	...
	case "rop": 
		$adresar = "rop"; 
		echo "<obrazek href=\"https://intranet.ssok.cz/obrazky/srop.jpg\" text=\"\" />\n";
		echo "<obrazek href=\"https://intranet.ssok.cz/obrazky/rop.jpg\" text=\"\" />\n";
		break;
	case "projekty": 
		$path = "/share/"; $adresar = "projekty"; 
		echo "<obrazek href=\"https://intranet.ssok.cz/obrazky/EU.png\" text=\"\" />\n";
		echo "<obrazek href=\"https://intranet.ssok.cz/obrazky/mmr.png\" text=\"\" />\n";
		...
		if ($file != "." && $file != "..") {
	   		if (is_dir($path.$adresar.$dir."/".$file)) {
				...
				if (preg_match("/\.(xls|doc|pdf|txt|xlsx|docx|ppt|zip|rar)$/i", $file)) {
		   			echo "<soubor href=\"https://intranet.ssok.cz/soubor-web.php?adresar=$adresar&amp;soubor=".(urlencode($dir)."/".urlencode($file))."\" text=\"$file (".ceil(filesize($path.$adresar.$dir."/".$file)/1000)."kB)\" />\n";
				}
			}
		}
	}
